...
- Servir como base para uma loja virtual completa no futuro
...
O site está sendo desenvolvido com abordagem mobile-first, garantindo boa experiência em:
- Celulares 
- Tablets 
- Computadores
...
- possível transformação em negócio digital